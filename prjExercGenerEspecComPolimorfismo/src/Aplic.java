...
public class Aplic {
    public static void main(String[] args) {
        ...
        System.out.println("Base             : " + pf1.getBase());
        System.out.println("Total de compras : " + pf1.getTotalCompras());
        System.out.println("Bonus            : " + pf1.calcBonus(2024));
        ...
        System.out.println("Total de compras  : " + pj1.getTotalCompras());
        System.out.println("Bonus             : " + pj1.calcBonus(2024));
    }
}
